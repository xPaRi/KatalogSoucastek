#############################################################################
# Makefile for building: KEY_PRO
# Generated by qmake (3.1) (Qt 5.14.2)
# Project:  ..\KEY_PRO.pro
# Template: app
# Command: D:\Qt\Qt5.14.2\5.14.2\mingw73_32\bin\qmake.exe -o Makefile ..\KEY_PRO.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
ZIP           = zip -r -9
DEF_FILE      = 
RES_FILE      = KEY_PRO_resource_res.o
...
Makefile: ../KEY_PRO.pro D:/Qt/Qt5.14.2/5.14.2/mingw73_32/mkspecs/win32-g++/qmake.conf D:/Qt/Qt5.14.2/5.14.2/mingw73_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile ..\KEY_PRO.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
